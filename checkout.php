                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                            ...
                            <div class="checkout__input">
                                ...
                                <input type="text" placeholder="Street Address" class="checkout__input__add" minlength="3" maxlength="30">
                                <input type="text" placeholder="Apartment, suite, unite ect (optinal)" minlength="1" maxlength="15">
                            </div>
                            <div class="checkout__input">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="checkout__input">
                                        <p>Phone<span>*</span></p>
                                        <input type="text" minlength="8" maxlength="16">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="checkout__input">
                                        <p>Email<span>*</span></p>
                                        <input type="text" minlength="6" maxlength="30">
                                    </div>
                                </div>
                            </div>
                        </div>
